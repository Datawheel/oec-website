...
class Custom extends Component {
  ...
  componentDidMount() {
    ...
    const SUBNATIONAL_NOT_AVAILABLE = ["deu"];
    const SUBNATIONAL_AVAILABLE = SUBNATIONAL_COUNTRIES.filter(d => d.available === true).sort((a, b) => a.name.localeCompare(b.name)).filter(d => !SUBNATIONAL_NOT_AVAILABLE.includes(d.code));
