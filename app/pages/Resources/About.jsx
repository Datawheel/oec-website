  ...
  render() {
    const team = [
      ...
      },
      {
        ...
        description: <p>Dave designed the 2013 version of the website, along with being co-author of the underlying visualization engine <a href="http://www.d3plus.org/" target="_blank">D3plus</a>. He continues to support the site with improvements to the front-end in both the visualizations and the overall navigation.</p>,
        img: "dave_landry.jpg",
    ...
    return (
      <div className="about">
        ...
        <p> The Observatory of Economic Complexity is a tool that allows users to quickly compose a visual narrative about countries and the products they exchange. It was <a href="https://www.media.mit.edu/publications/the-observatory-designing-data__driven-decision-making-tools/" target="_blank" rel="noopener noreferrer">Alexander Simoes&apos; Master Thesis</a> in Media Arts and Sciences at the MIT Media Lab. </p>

        <p> The project was conducted at The MIT Media Lab <a href="http://macro.media.mit.edu/" target="_blank" rel="noopener noreferrer">Macro Connections</a> group (now Collective Learning). Alex&apos;s Advisor was <a href="https://chidalgo.com/" target="_blank" rel="noopener noreferrer">César A. Hidalgo</a>, principal investigator of Macro Connections. Since its creation in 2010, the development of The Observatory of Economic Complexity has been supported by The MIT Media Lab consortia for undirected research. </p>
