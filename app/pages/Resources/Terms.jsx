  ...
  render() {
    ...
    return (
      <div className="terms">
        ...
        <p>
          <em>Last updated February 20, 2020</em>
        </p>

        <h2>Agreement to Terms</h2>
        <p>
          These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;) and Datawheel LLC (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), concerning your access to and use of the OEC website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the &quot;Site&quot;). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms and Conditions. IF YOU DO NOT AGREE WITH ALL OF THESE Terms and Conditions, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE ITS USE IMMEDIATELY.
        </p>
        <p>
        ...
        <p>
          Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (collectively, the “Content”) and the trademarks, service marks, and logos contained therein (the “Marks”) are owned or controlled by us or licensed to us, and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of the United States, foreign jurisdictions, and international conventions. The Content and the Marks are provided on the Site “AS IS” for your information and personal use only.
        </p>
        <p>
        ...
        <ol>
          ...
          <li>you will not share your account with other individuals</li>
        ...
        <ol>
          <li>sell, rent, lease, transfer, assign, distribute, host, or otherwise commercially exploit the Site.</li>
          <li>change, make derivative works of, disassemble, reverse compile or reverse engineer any part of the Site.</li>
          <li>access the Site in order to build a similar or competitive website.</li>
        </ol>

        <h2>Contribution License</h2>
        <p>
          You and Site agree that we may access, store, process, and use any information and personal data that you provide following the terms of the <Link to="/en/resources/privacy">Privacy Policy</Link> and your choices (including settings).
        </p>
        <p>
        ...
        <p>
          Like any other website, the OEC uses cookies. These cookies are used to store information including your preferences and the pages on the website that you have accessed or visited. The information is used to optimize your experience by customizing our web page content based on your browser type and/or other information.
        </p>
        ...
        <h2>Contact Us</h2>
        <p>
          In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: <a href={`mailto:${EMAIL}`}>{EMAIL}</a>
        </p>
