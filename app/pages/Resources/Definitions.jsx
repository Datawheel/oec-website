		...
		return (
			<div className="definitions">
				...
				<p>
					...
					capabilities. This includes the knowledge, institutions, and infrastructure that economies need to
					produce and export products, or the capabilities that firms, cities, and regions need to enter into
					new technologies and industries.
				</p>

				<p>
					What makes the field of Economic Complexity somehow unique, is that it studies the geography of
					productive capabilities and its dynamics using an outcomes based approach. That is, instead of
					trying to figure out what capabilities are a-priori, it uses data on what economies do to infer what
					capabilities an economy has. For example, by using the tools of economic complexity, one can take
					data on the products that a country exports and predict the products that this country could export
					in the future.<sup>11,12</sup> This is not because these methods help you identify exactly what each
					product or industry needs, but because they leverage the idea that similar industries have similar
					needs to estimate the percentage of capabilities that may be present in a location (without having
					to identify what these capabilities are). Similarly, Economic Complexity methods have also been
					shown to predict a country’s expected level of income,<sup>13,14</sup> economic growth,<sup>13,14</sup>{' '}
					income inequality,<sup>15</sup> emissions,<sup>16,17</sup> and the spatial concentration of economic
					activities.<sup>18</sup>
				</p>

				<p>
					The field of Economic Complexity is closely related to other fields of study, such as Economic
					Geography, which has long focused on the geographic distribution of economic activity, and Network
					Science, since Economic Complexity uses methods developed originally in the Network Science and
					Complex Systems community.
				</p>

				<p>
					As a concept, Economic Complexity is related to the idea of the division of labor, or more
					specifically, the division of knowledge. Because individuals are limited in what they can know,<sup>15,19</sup>{' '}
					the only way economies can expand their knowledge is by dividing it up among many individuals.
					Complex products, like medical imaging devices or jet engines, require vast amounts of knowledge
					that can only be accumulated by large networks of people. The accumulation of vast amounts of
					knowledge in large professional networks is only possible in economies with good institutions,
					social capital, infrastructure, and education.<sup>19</sup> This implies that the production of
					complex products represents evidence of “all of the above:” the simultaneous presence of detailed
					capabilities. Economic complexity is therefore related to an economy’s ability to engage in
					knowledge intensive industries, products, and technologies, and is expressed in the composition of a
					country’s or region’s productive output.
				</p>

				<h2>Who uses Economic Complexity methods?</h2>

				<p>
					Outside academia, Economic Complexity methods are used by multilateral organizations and national
					development agencies focused on economic development, by export promotion agencies and shipping
					companies to predict the evolution of international trade patterns, and by financial companies to
					create financial instruments (because of the ability of economic complexity methods to predict long
				...
				<p>
					The principle of relatedness<sup>13</sup> is a statistical law that tells us that the probability
					that a location (a country, city, or region), enters an economic activity (e.g. a product, industry,
					technology), grows with the number of related activities present in a location. The principle of
					relatedness can be used to predict which activities a location is more likely to enter or exit. It
					has been shown to be true for countries entering new products,<sup>12,15</sup> regions entering new
					industries,<sup>20,21</sup> cities patenting in new technologies,<sup>22,23</sup> and even
					universities publishing in new research areas.<sup>24</sup>
				</p>

				<h3>The Economic Complexity Index (ECI):</h3>

				<p>
					The Economic Complexity Index, or ECI, is a measure of an economy’s capacity which can be inferred
					from data connecting locations to the activities that are present in them. The Economic Complexity
					Index has been shown to predict important macroeconomic outcomes, including a country’s level of
					income,<sup>14,15</sup> economic growth,<sup>14,15</sup> income inequality,<sup>16</sup> and
					emissions.<sup>17,18</sup> It has also been estimated using diverse data sources, such as trade
					data,<sup>14,15</sup> employment data,<sup>25</sup> stock market data,<sup>26</sup> and patent data.<sup>27</sup>
				</p>

				<h3>The Product Complexity Index (PCI):</h3>

				<p>
					The Product Complexity Index, or PCI, is a measure of the complexity required to produce a product
					or engage in an economic activity. The Product Complexity Index is correlated with the spatial
					concentration of economic activities.<sup>28</sup>
				</p>

				<h3>Proximity:</h3>

				<p>
					Proximity is the idea of measuring similarity between activities, or locations. There are multiple
					ways to estimate proximity, using simple indicators such as conditional probabilities,<sup>12</sup>{' '}
					or more sophisticated indicators, such as the ratio between observed coincidences and those expected
					from an econometric model.<sup>20,21</sup>
				</p>

				<h2>What is Relatedness?</h2>

				<p>
					Relatedness measures the “similarity” or “compatibility” between an economy and an activity. For
					instance, it can be used to estimate whether the export structure of Bulgaria is compatible with
					what is needed to export cars, or if the technologies in which Toulouse has patented in the past are
					compatible with patenting on another technology, such as liquid crystal displays. Relatedness can be
					used to predict the probability that a location will enter or exit an activity.
				</p>

				<p>
					Usually, scholars measure the relatedness of a location and the economic activities in which that
					location is not currently engaged in to predict the probability that the region will enter that
					activity in the future. Similarly, low relatedness values predict the activities that a location
				...
				<p>
					Relatedness is usually calculated by looking at the percentage of related activities that are
					present in a location. Formally, let {' '}
				...
				<p>
					Higher relatedness values are associated with a higher probability of entering an activity in the
					future, or of growth in that activity (more exports, employment, etc). Low relatedness values are
					associated with a decrease in the activity and a higher probability of exit.
				</p>

				<h2>How is the Economic Complexity Index calculated?</h2>

				<p>
					The problem of estimating economic complexity is the problem of estimating both, the complexity of
					locations (e.g. countries, cities, regions) and that of the activities present in them (e.g.
					products, industries, technologies). The general idea is that the activities present, produced, or
					exported from a location, carry information about the complexity of that location, while the
					locations where an activity is present carry information about the complexity required to perform an
					activity. For instance, we can say that cities like San Francisco, Boston, and New York, are
					complex, because they are home to complex activities. Similarly, we can say that an activity like
					biotech or aerospace is complex, if it is found mostly in complex economies, like those of Boston
					and San Francisco.
				</p>
				...
				<p>
					...
					when a location’s output in an activity is larger than what is expected for a location of the same
					size and an activity with the same total output. This can be done using an indicator such as a
					location’s Revealed Comparative Advantage (RCA) or Location Quotient (LQ).
				</p>
				...
				<p>Following this notation, the general assumption made by metrics of economic complexity is that:</p>
				...
				<p>
					These mappings imply that measures of the complexity of economies, or of economic activities, are
					solutions to self-consistent equations of the form:
				</p>
				...
				<p>
					These equations imply that metrics of the complexity of economies, or of the activities present in
					them, are respectively, eigenvectors of matrices connecting related countries (
					<MathJax.Context input="tex">
					...
					) (e.g. the Product Space). We note that the first set of equations provide a more general family of
					functions that includes functions that cannot be reduced to the linear forms, yet, they can provide
					results that are similar to those obtained by linear equations.
				</p>

				<p>
					These equations also tell us that measures of complexity are relative measures, since the complexity
					of a location or an activity can change because of changes in the entries for other locations or
					activities (other rows or columns in the {''}
					<MathJax.Context input="tex">
				...
				<p>
					Using the above framework, we define the Economic Complexity Index of a location, or ECI, as the
					average of the Product Complexity Index, or PCI, of the activities present in it. Similarly, we
					define the Product Complexity Index of an activity, or PCI, as the average Economic Complexity
					Index, or ECI, of the locations where that activity is present. That is, we define the complexity of
					a location as the average complexity of its activities, and the complexity of an activity, as the
					average complexity of the places where that activity is present. Formally, the ECI formula is the
				...
				<p>
					The first string of studies focused on the relationship between economic complexity and economic
					growth. The paper that introduced the idea of economic complexity,<sup>14</sup> showed that
					economies with higher economic complexity, per unit of GDP per capita, grew faster. This finding was
					later confirmed and expanded in a subsequent book (The Atlas of Economic Complexity) and in various
					papers using international and subnational level data.<sup>29–32</sup> On average, scholars find
					that an increase of one standard deviation in economic complexity, at the same level of GDP per
					capita, is associated with an increase in annualized growth of between 4% to 7%. This is a strong
					effect, but it is important to keep in mind that an increase of one standard deviation in ECI is an
					extremely large effect (since ECI values, which are normalized, range usually between -2 and 2).
				</p>

				<p>
					More recently, people studying economic complexity have turned their attention to other topics, such
					as income inequality and environmental sustainability.
				</p>

				<p>
					In recent years we have learned that countries with higher levels of economic complexity tend to
					experience lower levels of income inequality,<sup>16,33</sup> and also, to produce a comparatively
					lower number of emissions.<sup>17,18</sup>
				</p>

				<p>
					Together, the ability of economic complexity to predict economic growth, inequality, and lowered
					emissions, make it an interesting policy target for countries looking to foster inclusive
					development.
				</p>
