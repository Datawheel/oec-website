    ...
    return (
      <div className="faq">
        ...
        <div className="link-container">
          <a href="https://docs.google.com/spreadsheets/d/1iPk4UDFffbWG4kqoh6wOJY7j7WEvWPxaEImfljiTOB0/edit?usp=sharing" className="link">SITC Products</a>
        </div>

        <div className="link-container">
          <a href="https://docs.google.com/spreadsheets/d/1mPG5zgQmeh3vRsGQrIOq8hPONXNRGW1OC449ExAqMVs/edit?usp=sharing" className="link">HS Products</a>
        </div>

        <div className="link-container">
          <a href="https://docs.google.com/spreadsheets/d/1Ue5cRW2rWlsZrnISWEgzuUsouIt6C0YI9t_tAPewMio/edit" className="link">Site-Wide Translations</a>
        </div>
