...
export default function RouteCreate() {
  ...
  function genRandId(path) {
    const countryCandidates = ["chn", "deu", "usa", "jpn", "kor", "fra", "ita", "nld", "mex", "gbr", "can", "blx", "rus", "esp", "ind", "che", "mys", "sgp", "aus", "vnm", "bra", "tha", "pol", "idn", "sau", "tur", "cze", "irl", "aut", "swe", "are", "hkg", "hun", "zaf", "nor", "phl", "dnk", "svk", "rou", "fin", "chl", "irq", "prt", "arg", "irn", "qat", "isr", "nga", "kwt", "ukr", "per", "kaz", "bgd", "col", "dza", "nzl", "omn", "ago", "bgr", "grc", "egy", "blr", "ven", "svn", "ltu", "mar", "pak", "ecu", "gha", "srb", "lby", "tun", "khm", "mmr", "est", "aze", "lva", "lka", "cri", "civ", "gtm", "zmb", "cog", "png", "ury", "hnd", "dom", "uzb", "tto", "hrv", "jor", "bol", "cod", "tkm", "mng", "pry", "moz", "bih", "mkd", "ken", "slv", "isl", "brn", "bhr", "nic", "tza", "gab", "gnq", "sdn", "cmr", "mlt", "lbn", "cyp", "sen", "mdg", "geo", "mrt", "pan", "gin", "mda", "uga", "sur", "arm", "mus", "alb", "bfa", "mli", "eth", "guy", "lao", "zwe", "kgz", "prk", "tgo", "yem", "cub", "mac", "jam", "ssd", "cuw", "hti", "tcd", "lbr", "fji", "bhs", "tjk", "grl", "afg", "mwi", "sle", "npl", "syc", "slb", "ben", "syr", "ner", "cym", "mne", "brb", "blz", "vgb", "mhl", "mdv", "eri", "gnb", "abw", "vct", "atg", "rwa", "flk", "vut", "som", "btn", "gmb", "bdi", "pyf", "bmu", "cpv", "and", "tls", "pse", "com", "kna", "wsm", "niu", "caf", "dji", "kir", "dma", "cok", "grd", "asm", "maf", "fsm"];
